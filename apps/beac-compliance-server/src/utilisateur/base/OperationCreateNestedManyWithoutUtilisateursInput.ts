...
@InputType()
class OperationCreateNestedManyWithoutUtilisateursInput {
...
export { OperationCreateNestedManyWithoutUtilisateursInput as OperationCreateNestedManyWithoutUtilisateursInput };
