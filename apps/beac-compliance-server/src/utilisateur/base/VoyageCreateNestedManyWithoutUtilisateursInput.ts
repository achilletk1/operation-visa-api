...
@InputType()
class VoyageCreateNestedManyWithoutUtilisateursInput {
...
export { VoyageCreateNestedManyWithoutUtilisateursInput as VoyageCreateNestedManyWithoutUtilisateursInput };
