...
@InputType()
class OperationCreateNestedManyWithoutCategoriesInput {
...
export { OperationCreateNestedManyWithoutCategoriesInput as OperationCreateNestedManyWithoutCategoriesInput };
