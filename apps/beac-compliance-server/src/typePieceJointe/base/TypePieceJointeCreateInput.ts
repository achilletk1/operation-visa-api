...
@InputType()
class TypePieceJointeCreateInput {
  @ApiProperty({
    required: false,
    type: Boolean,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PieceJointeCreateNestedManyWithoutTypePieceJointesInput,
  })
  @ValidateNested()
  @Type(() => PieceJointeCreateNestedManyWithoutTypePieceJointesInput)
  @IsOptional()
  @Field(() => PieceJointeCreateNestedManyWithoutTypePieceJointesInput, {
    nullable: true,
  })
  pieceJointes?: PieceJointeCreateNestedManyWithoutTypePieceJointesInput;
}

export { TypePieceJointeCreateInput as TypePieceJointeCreateInput };
