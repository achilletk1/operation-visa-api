...
@InputType()
class MoisPaiementEnLigneCreateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () => OperationCreateNestedManyWithoutMoisPaiementEnLignesInput,
  })
  @ValidateNested()
  @Type(() => OperationCreateNestedManyWithoutMoisPaiementEnLignesInput)
  @IsOptional()
  @Field(() => OperationCreateNestedManyWithoutMoisPaiementEnLignesInput, {
    nullable: true,
  })
...
export { MoisPaiementEnLigneCreateInput as MoisPaiementEnLigneCreateInput };
