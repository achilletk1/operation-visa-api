    ...
    const templates = [
        {
            ...
            email:{
                french:`Nous tenons à vous informer que le montant total ({{total}}) des opérations hors
                ...
                Aller à
                        l'application`,
                english:`We would like to inform you that the total amount ({{total}}) of transactions outside the
            ...
            sms:{
                french:`Chèr(e) client(e) nous tenons à vous informer que le montant total ({{total}}) des opérations hors
                zone CEMAC que vous avez effectués le
                {{start}} a
                dépassé le plafond autorisé par la
                BEAC qui est de
                ...
                circulaireBEAC
                    ...
                    la plateforme digitale BCIONLINE : via le
                    lien //`,
                english:`Dear customer, we would like to inform you that the total amount ({{total}}) of transactions outside the
                CEMAC zone that you carried out on
                {{start}} has
                exceeded the
                BEAC which is
...

        {
            ...
            sms:{
               ...
               {{created}} comme le précise la circulaire BEAC N004/G4/2002. Vous pouvez le faire à distance en vous
                ...
                {{created}} as specified in BEAC circular N004/G4/2002. You can do this remotely by
