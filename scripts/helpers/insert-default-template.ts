    ...
    const templates = [
        {
            ...
            fr: {
                ...
                sms: `Bonjour,Nous vous informons que vos operations hors zone CEMAC du mois de {{MOIS_DEPART}} ({{MONTANT_XAF}} XAF) ont depasse le plafond de {{PLAFOND}} XAF. Merci de nous transmettre vos justificatifs sous 30 jours a compter du {{DATE}} via la plateforme BCIONLINE. Merci pour votre fidélite.`,
                obj: `Dépassement de plafond sur les transactions Hors zone CEMAC`,
            },

            en: {
                email: `We would like to inform you that the total amount ({{MONTANT_XAF}} XAF) of transactions outside the CEMAC zone that you carried out in the month of {{MOIS_DEPART}} has exceeded the ceiling authorized by BEAC, which is {{PLAFOND}}. XAF.// 
                ...
                You can do this remotely by connecting to the BCIONLINE digital platform: via the link .//
                Thank you for your loyalty.`,

                sms: `we inform you that your operations outside the CEMAC zone for the month of {{MOIS_DEPART}} ({{MONTANT_XAF}} XAF) have exceeded the ceiling of {{PLAFOND}} XAF. Please send us your receipts within 30 days from {{DATE}} via the BCIONLINE platform. Thank you for your loyalty.`,
...

        {
            ...
            fr: {
                ...
                Vous pouvez le faire à distance en vous connectant à la plateforme digitale BCIONLINE : via le lien  //
                Nous vous remercions pour votre. fidélité.`,
                ...
                {{DATE}} via la plateforme digitale BCIONLINE. Nous vous remercions pour votre fidelite.`,
            ...
            en: {
                ...
                sms: `Hello, we have detected a transaction outside the CEMAC zone. Please provide us with your proof within 30 days from {{DATE}} via BCIONLINE`,
...

        {
            ...
            fr: {
                email: `
                Chèr(e) {{NOM_CLIENT}} ,        
                Nous avons remarqué des transactions non justifiées dans les délais sur votre compte bancaire. Comme le précise la
                circulaire BEAC N004/GR/2022 nous avons l'obligation de bloquer votre carte bancaire.
            ...
            en: {
                email: `Dear {{NAME_CLIENT}} ,        
                We have noticed some unjustified transactions on your bank account. As specified in
