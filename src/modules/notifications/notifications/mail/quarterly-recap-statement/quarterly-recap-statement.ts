...
export class QuarterlyRecapStatementMailNotification extends BaseMailNotification<QuarterlyRecapStatementEvent> {
    ...
    static async init(notificationData: QuarterlyRecapStatementEvent) {
        ...
        return new QuarterlyRecapStatementMailNotification(notificationData);
    }
}