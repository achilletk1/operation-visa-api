...
// READ
export enum SuppliersVoucherSettingMenuAuthorizationsRead {
    SUPPPLIERS_VOUCHER_SETTING_MENU_VIEW = 'SUPPPLIERS_VOUCHER_SETTING_MENU_VIEW'
}
// READ
export enum SuppliersMenuAuthorizationsRead {
    SUPPPLIERS_MENU_VIEW = 'SUPPPLIERS_MENU_VIEW'
}
// READ
...
// READ
export enum SuppliersVoucherSettingAuthorizationsRead {
    SUPPLIER_VOUCHER_SETTING_LIST_VIEW = 'SUPPLIER_VOUCHER_SETTING_LIST_VIEW', SUPPLIER_VOUCHER_SETTING_BTN_RESET = 'SUPPLIER_VOUCHER_SETTING_BTN_RESET',
    OPERATION_VOUCHER_SETTING_FILTER_TYPES='OPERATION_VOUCHER_SETTING_FILTER_TYPES', 
}
// WRITE
export enum SuppliersVoucherSettingAuthorizationsWrite {
    SUPPLIER_VOUCHER_SETTING_ADD = 'SUPPLIER__VOUCHER_SETTING_ADD', SUPPLIER_VOUCHER_SETTING_BTN_EDITION = 'SUPPLIER_VOUCHER_SETTING_BTN_EDITION',
    SUPPLIER_VOUCHER_SETTING_NEW_VOUCHER = 'SUPPLIER_VOUCHER_SETTING_NEW_VOUCHER'
}
// READ
export enum OperationsAuthorizationsRead {
    ...
    OPERATION_FILTER_TYPES='OPERATION_FILTER_TYPES',  OPERATION_FILTER_OBJECT='OPERATION_FILTER_OBJECT',   OPERATION_FILTER_SUPPLIER=' OPERATION_FILTER_SUPPLIER',  OPERATION_FILTER_NAME='OPERATION_FILTER_NAME',
...
// READ
export enum SuppliersAuthorizationsRead {
    SUPPLIER_LIST_VIEW = 'SUPPLIER_LIST_VIEW', SUPPLIER_BTN_RESET = 'SUPPLIER_BTN_RESET',
    OPERATION_FILTER_TYPES='OPERATION_FILTER_TYPES', 
}
// WRITE
export enum SuppliersAuthorizationsWrite {
    SUPPLIER_DECLARATION = 'SUPPLIER_DECLARATION', SUPPLIER_BTN_EDITION = 'SUPPLIER_BTN_EDITION',
    SUPPLIER_NEW_DECLARATION = 'SUPPLIER_NEW_DECLARATION', SUPPLIER_ATTACH_IMPORT='SUPPLIER_ATTACH_IMPORT'
}
