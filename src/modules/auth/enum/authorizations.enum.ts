...
export enum CeilingIncreaseAuthorizationsRead {
    ...
    CEILING_FILTER_NAME = 'CEILING_FILTER_NAME', CEILING_BTN_RESET_FILTER = 'CEILING_BTN_RESET_FILTER',
}
// WRITE
...
export enum ReportingBeacAuthorizationsRead {
    // READ
    REPORT_BEAC_VIEW = 'REPORT_BEAC_VIEW', REPORT_BEAC_BTN_DOWNLOAD = 'REPORT_BEAC_BTN_DOWNLOAD',
    REPORT_BEAC_BTN_RESET = 'REPORT_BEAC_BTN_RESET', REPORT_BEAC_BTN_FILTER = 'REPORT_BEAC_BTN_FILTER',
    REPORT_BEAC_FILTER_DATES = 'REPORT_BEAC_FILTER_DATES', REPORT_BEAC_FILTER_TYPE = 'REPORT_BEAC_FILTER_TYPE',
}
